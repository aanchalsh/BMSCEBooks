...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("the New Chapter of");
...
ResultSet Rs = null;
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
      if(RoleCb.getSelectedItem().toString().equals("Seller"))
      {
       ...
       try{
           Con = DriverManager.getConnection("jdbc:derby://localhost:1527/BMSCEBooksJavadb","User1","1234");
    ...
    if(Rs.next()){
       ...
       }catch(SQLException ex)
       {
           ...
           //String Query = "select * from User1.ADMINTBL where ADMINNAME='"+"' and ADMINPASS='"+"'";
       try{
           Con = DriverManager.getConnection("jdbc:derby://localhost:1527/BMSCEBooksJavadb","User1","1234");
    St = Con.createStatement();
    Rs = St.executeQuery(Query);
